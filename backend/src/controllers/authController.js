...
const forgotPassword = asyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    const configuredBaseUrl = String(process.env.FRONTEND_URL || process.env.PUBLIC_APP_URL || process.env.APP_URL || '').trim();
    const frontendBaseUrl = configuredBaseUrl || `${req.protocol}://${req.get('host')}`;
