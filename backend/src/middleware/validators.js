...
const createGameValidator = [
  body('gameType')
    .isIn(['ranked', 'ai', 'practice', 'unranked_1v1'])
    .withMessage('Invalid game type'),
  body('aiDifficulty')
    .optional()
    .isIn(['easy', 'medium', 'hard', 'expert'])
    .withMessage('Invalid AI difficulty'),
  body('categories')
    .optional()
    .isArray()
...
const paginationValidator = [
  ...
  query('limit')
    ...
    .withMessage('Limit must be "all" or an integer between 1 and 5000'),
  validate
];
...
const leaderboardValidator = [
  ...
  query('category')
    .optional()
    .isIn([
      'biology', 'chemistry', 'physics', 'mathematics', 'math', 'earth and space', 'earth-space', 'energy', 'other',
      'Biology', 'Chemistry', 'Physics', 'Mathematics', 'Earth and Space', 'Energy', 'Other'
    ])
